...
- [x] Implement ordered OOXML cell patching and atomic zip replacement.
- [x] Implement inline strings, formula/value mechanics, shared-formula expansion, and array refusal.
- [x] Implement calc metadata edits, calcChain triple-delete, lock/conflict preconditions, and dimensions.
- [x] Implement direct index patching, generation bumps, and transitive staleness.
- [x] Prove I18 on F16/F21 and with property tests.
- [x] Complete a live-Excel round-trip smoke test.
- [x] Pass R-mech and R-test gates.

### P7 — MCP server and CLI

- [x] Implement all 14 tools with Pydantic schemas and canonical structured errors.
- [x] Enforce path confinement, regex deadline, freshness, value/character caps, and generation cursors.
- [x] Add MCP annotations, initialization instructions, and indexing progress.
- [x] Implement the full CLI including Mermaid graph output and benchmark command.
- [x] Pass T6 conformance plus R-mech and R-test gates.
