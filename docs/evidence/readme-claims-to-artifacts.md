...
| LIM-02 | Dynamic references such as `INDIRECT` are opaque but diagnosed. | P3/P5 | Planned P5 | `tests/unit/test_reference_extraction.py::test_f11_dynamic_references_are_opaque`<br>`tests/golden/f11-diagnostics.json`<br>`docs/evidence/p5-diagnostics.md#dynamic-reference-diagnostics` |
...
| LIM-07 | Spill extents are not statically tracked. | P3 | Planned P3 | `tests/unit/test_reference_extraction.py::test_f19_spill_reference_targets_anchor_only`<br>`docs/evidence/p3-formulas-blocks.md#spill-reference-scope` |
