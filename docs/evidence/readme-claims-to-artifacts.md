...
| LIM-05 | Datetime writes are rejected in v0.1.0. | P6/P7 | Planned P7 | `tests/unit/test_editor.py::test_invalid_write_values_fail_before_any_package_mutation`<br>`tests/mcp/test_conformance.py::test_write_cells_rejects_datetime_without_traceback` |
| LIM-06 | Writes inside multi-cell array formulas are refused. | P6/P7 | Planned P7 | `tests/unit/test_editor.py::test_multi_cell_array_formula_refuses_anchor_and_follower_without_writing`<br>`tests/mcp/test_conformance.py::test_write_tools_refuse_multicell_array_members` |
